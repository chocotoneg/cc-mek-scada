...
function facility.create(tool_ctl, main_pane, cfg_sys, fac_cfg, style)
    ...
    TextBox{parent=fac_c_2,x=7,y=5,text="reatores"}
    TextBox{parent=fac_c_2,x=1,y=7,height=3,text="Isso determina quantos monitores voc\xea precisa. Se esse n\xb0 n\xe3o corresponder a quantidade de reatores do supervisor, o coordenador n\xe3o ser\xe1 conectado.",fg_bg=g_lg_fg_bg}
    ...
    function self.show_sv_cfg()
        ...
        local str = util.sprintf("Instala\xe7\xe3o tem %d unidade%s de reatores:", #conf, tri(#conf==1,"","s"))
