...
local function init(parent, id)
    ...
    TextBox{parent=main,x=12,y=25,text="Taxa de Queima",width=19,fg_bg=style.label}
    ...
    local plc_hbeat  = IndicatorLight{parent=annunciator,label="Pulso do PLC",colors=ind_wht}
    ...
    local r_wloc  = IndicatorLight{parent=annunciator,label="Oclus\xe3o de Res\xedduos",colors=ind_yel}
    ...
    local rps_flt = IndicatorLight{parent=rps_annunc,label="Falha no PPM",colors=ind_yel,flash=true,period=period.BLINK_500_MS}
    ...
    local rps_sfl = IndicatorLight{parent=rps_annunc,label="Falha no Sistema",colors=ind_red,flash=true,period=period.BLINK_500_MS}
    ...
    TextBox{parent=main,text="CTRL AUTO",fg_bg=cpair(colors.black,colors.purple),alignment=ALIGN.CENTER,width=13,x=32,y=36}
