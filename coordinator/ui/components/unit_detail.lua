...
local function init(parent, id)
    ...
    TextBox{parent=main,text="Reator Unidade #" .. id,alignment=ALIGN.CENTER,fg_bg=style.theme.header}
    ...
    TextBox{parent=main,x=12,y=22,text="Taxa de Aquecimento",width=12,fg_bg=style.label}
    ...
    TextBox{parent=main,x=12,y=25,text="Taxa Queima Atual",width=20,fg_bg=style.label}
    ...
    TextBox{parent=main,x=32,y=22,text="Temp. do N\xfacleo",width=9,fg_bg=style.label}
    ...
    TextBox{parent=main,x=32,y=25,text="Taxa de Queima",width=9,fg_bg=style.label}
    ...
    local stat_line_1 = TextBox{parent=u_stat,x=1,y=1,text="DESCONHECIDO",width=33,alignment=ALIGN.CENTER,fg_bg=bw_fg_bg}
    local stat_line_2 = TextBox{parent=u_stat,x=1,y=2,text="esperando info...",width=33,alignment=ALIGN.CENTER,fg_bg=gry_wht}
    ...
    local plc_hbeat  = IndicatorLight{parent=annunciator,label="PLC Pulso",colors=ind_wht}
    local rad_mon    = TriIndicatorLight{parent=annunciator,label="Monitor de Radia\xe7\xe3o",c1=ind_bkg,c2=ind_yel.fgd,c3=ind_grn.fgd}
    ...
    -- operating state
    local r_active = IndicatorLight{parent=annunciator,label="Reator Ativo",colors=ind_grn}
    local r_auto   = IndicatorLight{parent=annunciator,label="Controle Auto",colors=ind_wht}
    ...
    local r_scram = IndicatorLight{parent=annunciator,label="SCRAM do Reator",colors=ind_red}
    local r_mscrm = IndicatorLight{parent=annunciator,label="SCRAM Manual",colors=ind_red}
    local r_ascrm = IndicatorLight{parent=annunciator,label="SCRAM Autom\xe1tico",colors=ind_red}
    local rad_wrn = IndicatorLight{parent=annunciator,label="Aviso de Radia\xe7\xe3o",colors=ind_yel}
    local r_rtrip = IndicatorLight{parent=annunciator,label="Desarme RCP",colors=ind_red}
    local r_cflow = IndicatorLight{parent=annunciator,label="Fluxo RCS Baixo",colors=ind_yel}
    local r_clow  = IndicatorLight{parent=annunciator,label="Refrig. Baixa",colors=ind_yel}
    local r_temp  = IndicatorLight{parent=annunciator,label="Temp. do Reator Alta",colors=ind_red}
    local r_rhdt  = IndicatorLight{parent=annunciator,label="Delta T d'Reator Alto",colors=ind_yel}
    local r_firl  = IndicatorLight{parent=annunciator,label="Taxa de Comb. Baixa",colors=ind_yel}
    local r_wloc  = IndicatorLight{parent=annunciator,label="Oclus\xe7\xe3o de Res\xedduos",colors=ind_yel}
    local r_hsrt  = IndicatorLight{parent=annunciator,label="Taxa de Inicio Alta",colors=ind_yel}
    ...
    TextBox{parent=main,text="SISTEMA DE PROTE\xc7\xc3O DO REATOR",fg_bg=cpair(colors.black,colors.cyan),alignment=ALIGN.CENTER,width=33,x=46,y=8}
    ...
    local rps_trp = IndicatorLight{parent=rps_annunc,label="Desarme SPR",colors=ind_red,flash=true,period=period.BLINK_250_MS}
    ...
    local rps_exh = IndicatorLight{parent=rps_annunc,label="Refrig. Muito Aquecida",colors=ind_yel}
    local rps_exw = IndicatorLight{parent=rps_annunc,label="Res\xedduo Excessivo",colors=ind_yel}
    local rps_tmp = IndicatorLight{parent=rps_annunc,label="Temp. do N\xfacleo Alta",colors=ind_red,flash=true,period=period.BLINK_250_MS}
    local rps_nof = IndicatorLight{parent=rps_annunc,label="Sem Combust\xedvel",colors=ind_yel}
    local rps_loc = IndicatorLight{parent=rps_annunc,label="N\xedvel de Refrig. Baixo",colors=ind_yel}
    local rps_flt = IndicatorLight{parent=rps_annunc,label="Falha PPM",colors=ind_yel,flash=true,period=period.BLINK_500_MS}
    local rps_tmo = IndicatorLight{parent=rps_annunc,label="Tempo de Conex\xe3o Esgotado",colors=ind_yel,flash=true,period=period.BLINK_500_MS}
    local rps_sfl = IndicatorLight{parent=rps_annunc,label="Falha do Sistema",colors=ind_red,flash=true,period=period.BLINK_500_MS}
    ...
    TextBox{parent=main,text="SISTEMA DE REFRIG. DO REATOR",fg_bg=cpair(colors.black,colors.blue),alignment=ALIGN.CENTER,width=33,x=46,y=22}
    ...
    local c_flt  = IndicatorLight{parent=rcs_annunc,label="Falha de Hardware RCS",colors=ind_yel}
    local c_emg  = TriIndicatorLight{parent=rcs_annunc,label="Refrig. de Emerg\xeancia",c1=ind_bkg,c2=ind_wht.fgd,c3=ind_grn.fgd}
    local c_cfm  = IndicatorLight{parent=rcs_annunc,label="Alimen. Refrig. Imprecisa",colors=ind_yel}
    local c_brm  = IndicatorLight{parent=rcs_annunc,label="Diverg\xeancia na Ebuli\xe7\xe3o",colors=ind_yel}
    local c_sfm  = IndicatorLight{parent=rcs_annunc,label="Diverg\xeancia de Vapor",colors=ind_yel}
    local c_mwrf = IndicatorLight{parent=rcs_annunc,label="Retorno M\xe1x. de \xc1gua",colors=ind_yel}
    ...
    local t1_sdo = TriIndicatorLight{parent=rcs_annunc,label="V\xe1lvula de Al\xedvio Aberta",c1=ind_bkg,c2=ind_yel.fgd,c3=ind_red.fgd}
    t1_sdo.register(t_ps[1], "SteamDumpOpen", t1_sdo.update)

    TextBox{parent=rcs_tags,text="T1",width=2,fg_bg=hc_text}
    local t1_tos = IndicatorLight{parent=rcs_annunc,label="Sobrerrota\xe7\xe3o da Turbina",colors=ind_red}
    t1_tos.register(t_ps[1], "TurbineOverSpeed", t1_tos.update)

    TextBox{parent=rcs_tags,text="T1",width=2,fg_bg=hc_text}
    local t1_gtrp = IndicatorLight{parent=rcs_annunc,label="Desarme do Gerador",colors=ind_yel,flash=true,period=period.BLINK_250_MS}
    t1_gtrp.register(t_ps[1], "GeneratorTrip", t1_gtrp.update)

    TextBox{parent=rcs_tags,text="T1",width=2,fg_bg=hc_text}
    local t1_trp = IndicatorLight{parent=rcs_annunc,label="Desarme da Turbina",colors=ind_red,flash=true,period=period.BLINK_250_MS}
    ...
    if unit.num_turbines > 1 then
        ...
        local t2_sdo = TriIndicatorLight{parent=rcs_annunc,label="V\xe1lvula de Al\xedvio Aberta",c1=ind_bkg,c2=ind_yel.fgd,c3=ind_red.fgd}
        t2_sdo.register(t_ps[2], "SteamDumpOpen", t2_sdo.update)

        TextBox{parent=rcs_tags,text="T2",width=2,fg_bg=hc_text}
        local t2_tos = IndicatorLight{parent=rcs_annunc,label="Sobrerrota\xe7\xe3o da Turbina",colors=ind_red}
        t2_tos.register(t_ps[2], "TurbineOverSpeed", t2_tos.update)

        TextBox{parent=rcs_tags,text="T2",width=2,fg_bg=hc_text}
        local t2_gtrp = IndicatorLight{parent=rcs_annunc,label="Desarme do Gerador",colors=ind_yel,flash=true,period=period.BLINK_250_MS}
        t2_gtrp.register(t_ps[2], "GeneratorTrip", t2_gtrp.update)

        TextBox{parent=rcs_tags,text="T2",width=2,fg_bg=hc_text}
        local t2_trp = IndicatorLight{parent=rcs_annunc,label="Desarme da Turbina",colors=ind_red,flash=true,period=period.BLINK_250_MS}
    ...
    if unit.num_turbines > 2 then
        ...
        local t3_sdo = TriIndicatorLight{parent=rcs_annunc,label="V\xe1lvula de Al\xedvio Aberta",c1=ind_bkg,c2=ind_yel.fgd,c3=ind_red.fgd}
        t3_sdo.register(t_ps[3], "SteamDumpOpen", t3_sdo.update)

        TextBox{parent=rcs_tags,text="T3",width=2,fg_bg=hc_text}
        local t3_tos = IndicatorLight{parent=rcs_annunc,label="Sobrerrota\xe7\xe3o da Turbina",colors=ind_red}
        t3_tos.register(t_ps[3], "TurbineOverSpeed", t3_tos.update)

        TextBox{parent=rcs_tags,text="T3",width=2,fg_bg=hc_text}
        local t3_gtrp = IndicatorLight{parent=rcs_annunc,label="Desarme do Gerador",colors=ind_yel,flash=true,period=period.BLINK_250_MS}
        t3_gtrp.register(t_ps[3], "GeneratorTrip", t3_gtrp.update)

        TextBox{parent=rcs_tags,text="T3",width=2,fg_bg=hc_text}
        local t3_trp = IndicatorLight{parent=rcs_annunc,label="Desarme da Turbina",colors=ind_red,flash=true,period=period.BLINK_250_MS}
    ...
    local start = HazardButton{parent=main,x=2,y=28,text="LIGAR",accent=colors.lightBlue,dis_colors=dis_colors,callback=unit.start,fg_bg=hzd_fg_bg}
    local ack_a = HazardButton{parent=main,x=12,y=32,text="Conf\x13",accent=colors.orange,dis_colors=dis_colors,callback=unit.ack_alarms,fg_bg=hzd_fg_bg}
    ...
    TextBox{parent=main,text="PROCESSAMENTO DE RES\xcdDUO",fg_bg=cpair(colors.black,colors.brown),alignment=ALIGN.CENTER,width=33,x=46,y=48}
    ...
    local a_brc = AlarmLight{parent=alarm_panel,x=6,y=2,label="Conten\xe7\xe3o Rompida",c1=ind_bkg,c2=ind_red.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_250_MS}
    local a_rad = AlarmLight{parent=alarm_panel,x=6,label="Radia\xe7\xe3o na Conten\xe7\xe3o",c1=ind_bkg,c2=ind_red.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_250_MS}
    local a_dmg = AlarmLight{parent=alarm_panel,x=6,label="Dano Cr\xedtico",c1=ind_bkg,c2=ind_red.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_250_MS}
    alarm_panel.line_break()
    local a_rcl = AlarmLight{parent=alarm_panel,x=6,label="Reator Perdido",c1=ind_bkg,c2=ind_red.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_250_MS}
    local a_rcd = AlarmLight{parent=alarm_panel,x=6,label="Dano no Reator",c1=ind_bkg,c2=ind_red.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_250_MS}
    local a_rot = AlarmLight{parent=alarm_panel,x=6,label="Sobreaquec. do Reator",c1=ind_bkg,c2=ind_red.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_250_MS}
    local a_rht = AlarmLight{parent=alarm_panel,x=6,label="Temp. Alta do Reator",c1=ind_bkg,c2=ind_yel.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_500_MS}
    local a_rwl = AlarmLight{parent=alarm_panel,x=6,label="Vazamento de Res\xedduos",c1=ind_bkg,c2=ind_red.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_250_MS}
    local a_rwh = AlarmLight{parent=alarm_panel,x=6,label="N\xedvel de Res\xedduos Alto",c1=ind_bkg,c2=ind_yel.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_500_MS}
    alarm_panel.line_break()
    local a_rps = AlarmLight{parent=alarm_panel,x=6,label="RPS Transiente",c1=ind_bkg,c2=ind_yel.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_500_MS}
    local a_clt = AlarmLight{parent=alarm_panel,x=6,label="RCS Transiente",c1=ind_bkg,c2=ind_yel.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_500_MS}
    local a_tbt = AlarmLight{parent=alarm_panel,x=6,label="Desarme da Turbina",c1=ind_bkg,c2=ind_red.fgd,c3=ind_grn.fgd,flash=true,period=period.BLINK_250_MS}
    ...
    TextBox{parent=auto_div,text="Grupo Prio.",width=11,fg_bg=style.label}
    ...
    local a_rdy = IndicatorLight{parent=auto_div,label="Pronto",x=2,colors=ind_grn}
    local a_stb = IndicatorLight{parent=auto_div,label="Espera",x=2,colors=ind_wht,flash=true,period=period.BLINK_1000_MS}
