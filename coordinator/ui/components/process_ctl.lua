...
local function new_view(root, x, y)
    ...
    local matrix_dc   = IndicatorLight{parent=main,label="Matrix Disconectada",colors=ind_yel,flash=true,period=period.BLINK_500_MS}
    ...
    for i = 1, 4 do
        ...
        TextBox{parent=unit_tag,x=2,y=2,text="Unid. "..i.." Limite",width=7,height=2}
